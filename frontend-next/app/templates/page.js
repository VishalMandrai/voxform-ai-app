...
import SurveyTemplates from '@/components/Forms/SurveyTemplates';
...
export default function Templates() {
    ...
    useEffect(() => {
        // Setting Tab Title
        document.title = 'Templates | VoxForm AI';
    ...
    return (
        <div className="p-2">
            <div className="text-white overflow-hidden mb-5 mt-10">
                <main className="relative z-10 border-b border-[#13333d] pb-10">
                    ...
                    <span className="mt-1 text-3xl text-slate-500">
                        Choose from the available templates and start filling
                    </span>
                </main>
            </div>
            ...
            <div className="mx-auto mt-10 grid grid-cols-1 gap-4 md:ml-[0%] xl:ml-[0%]">
                {SurveyTemplates.map((form, index) => (
                    <TemplateCard
                        key={form.title}
                        form={form}
                        index={index + 1}
